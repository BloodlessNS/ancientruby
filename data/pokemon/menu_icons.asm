...
MonMenuIcons:
	...
	db ICON_FOX         ; TORCHIC
	db ICON_FOX         ; COMBUSKEN
	db ICON_FOX         ; BLAZIKEN
	...
	db ICON_NINJASK    ; NINCADA
	db ICON_JIGGLYPUFF  ; IGGLYBUFF
	db ICON_NINJASK    ; TOGEPI
