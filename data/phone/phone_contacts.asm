...
; entries correspond to PHONE_* constants
	...
	phone COOLTRAINERF, REENA1,             ROUTE_2,         ANYTIME, ReenaPhoneScript1,   ANYTIME, ReenaPhoneScript2
	...
	phone FISHER,       TULLY1,             ROUTE_43,         ANYTIME, TullyPhoneScript1,   ANYTIME, TullyPhoneScript2
	...
	phone BIRD_KEEPER,  VANCE1,             ROUTE_43,         ANYTIME, VancePhoneScript1,   ANYTIME, VancePhoneScript2
	phone FISHER,       WILTON1,            ROUTE_43,         ANYTIME, WiltonPhoneScript1,  ANYTIME, WiltonPhoneScript2
