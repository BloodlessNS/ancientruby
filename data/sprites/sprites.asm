...
; entries correspond to SPRITE_* constants
	...
	overworld_sprite SilverSpriteGFX, 12, WALKING_SPRITE, PAL_OW_GREEN
...
if DEF(_SAPPHIRE)
	overworld_sprite GruntSpriteGFX, 12, WALKING_SPRITE, PAL_OW_BLUE
else
	overworld_sprite GruntSpriteGFX, 12, WALKING_SPRITE, PAL_OW_RED
endc
	...
	overworld_sprite RaltsSpriteGFX, 4, STILL_SPRITE, PAL_OW_RED
