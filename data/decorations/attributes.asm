...
; entries correspond to deco constants
	...
	decoration DECO_POSTER,  NINJASK,       SET_UP_POSTER,     EVENT_DECO_POSTER_2,             $24
	...
	decoration DECO_DOLL,    NINJASK,       SET_UP_DOLL,       EVENT_DECO_NINJASK_DOLL,        SPRITE_NINJASK
	...
	decoration DECO_DOLL,    WINGULL,       SET_UP_DOLL,       EVENT_DECO_WINGULL_DOLL,        SPRITE_WINGULL
