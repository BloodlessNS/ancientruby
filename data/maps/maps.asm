...
MapGroup_Viridian:
	...
	map VictoryRoadGate, TILESET_GATE, GATE, ROUTE_27, MUSIC_INDIGO_PLATEAU, FALSE, PALETTE_DAY, FISHGROUP_SHORE
...
MapGroup_Littleroot:
	...
	map Route26HealHouse, TILESET_HOUSE, INDOOR, ROUTE_27, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map DayOfWeekSiblingsHouse, TILESET_HOUSE, INDOOR, ROUTE_27, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route27SandstormHouse, TILESET_HOUSE, INDOOR, ROUTE_27, MUSIC_AZALEA_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map Route29Route46Gate, TILESET_GATE, GATE, ROUTE_27, MUSIC_ROUTE_101, FALSE, PALETTE_DAY, FISHGROUP_SHORE
