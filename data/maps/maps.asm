...
MapGroup_Littleroot:
	...
	map OldaleTown, TILESET_JOHTO, TOWN, OLDALE_TOWN, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_AUTO, FISHGROUP_OCEAN
	map OldalePokecenter1F, TILESET_POKECENTER, INDOOR, OLDALE_TOWN, MUSIC_POKEMON_CENTER, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleMart, TILESET_MART, INDOOR, OLDALE_TOWN, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleHouse1, TILESET_HOUSE, INDOOR, OLDALE_TOWN, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
	map OldaleHouse2, TILESET_HOUSE, INDOOR, OLDALE_TOWN, MUSIC_LITTLEROOT_TOWN, FALSE, PALETTE_DAY, FISHGROUP_SHORE
