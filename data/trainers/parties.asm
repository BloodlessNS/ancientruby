...
FalknerGroup:
	...
	db  7, LOTAD,     TACKLE, MUD_SLAP, NO_MOVE, NO_MOVE
	db  9, LOMBRE,  TACKLE, MUD_SLAP, GUST, NO_MOVE
	db -1 ; end

WhitneyGroup:
	; WHITNEY (1)
	db "WHITNEY@", TRAINERTYPE_MOVES
	db 18, NINJASK,   DOUBLESLAP, MIMIC, ENCORE, METRONOME
...
BugsyGroup:
	...
	db 14, SILCOON,    TACKLE, STRING_SHOT, HARDEN, NO_MOVE
	db 14, CASCOON,     POISON_STING, STRING_SHOT, HARDEN, NO_MOVE
...
ErikaGroup:
	...
	db 42, SHIFTRY,    VINE_WHIP, BIND, GIGA_DRAIN, SLEEP_POWDER
...
YoungsterGroup:
	...
	db 21, MIGHTYENA,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, SCARY_FACE
	db -1 ; end
	...
	; YOUNGSTER (13)
	db "JOEY@", TRAINERTYPE_MOVES
	db 30, MIGHTYENA,   TAIL_WHIP, QUICK_ATTACK, HYPER_FANG, PURSUIT
	db -1 ; end
...
SchoolboyGroup:
	...
	db 32, SHIFTRY,    POISONPOWDER, VINE_WHIP, BIND, MEGA_DRAIN
...
BirdKeeperGroup:
	...
	db 38, LUDICOLO,    TOXIC, QUICK_ATTACK, WHIRLWIND, FLY
	db 38, LUDICOLO,    SWIFT, DETECT, STEEL_WING, FLY
	db -1 ; end
...
CooltrainerMGroup:
	...
	db 25, LUDICOLO,    SAND_ATTACK, QUICK_ATTACK, WHIRLWIND, WING_ATTACK
	...
	db 31, SEEDOT,  LEECH_SEED, CONFUSION, SLEEP_POWDER, SOLARBEAM
	db -1 ; end
...
CooltrainerFGroup:
	...
	db 25, BEAUTIFLY, CONFUSION, SLEEP_POWDER, WHIRLWIND, GUST
...
BugCatcherGroup:
	...
	db 24, BEAUTIFLY, CONFUSION, POISONPOWDER, SUPERSONIC, WHIRLWIND
	db 24, BEAUTIFLY, CONFUSION, STUN_SPORE, SUPERSONIC, WHIRLWIND
	db 25, DUSTOX,   FURY_ATTACK, FOCUS_ENERGY, TWINEEDLE, RAGE
	db 24, BEAUTIFLY, CONFUSION, SLEEP_POWDER, SUPERSONIC, WHIRLWIND
	db -1 ; end

	; BUG_CATCHER (16)
	db "WADE@", TRAINERTYPE_MOVES
	db 30, BEAUTIFLY, CONFUSION, POISONPOWDER, SUPERSONIC, GUST
	db 30, BEAUTIFLY, CONFUSION, STUN_SPORE, SUPERSONIC, GUST
	db 32, DUSTOX,   FURY_ATTACK, PURSUIT, TWINEEDLE, DOUBLE_TEAM
	db 34, BEAUTIFLY, PSYBEAM, SLEEP_POWDER, GUST, WHIRLWIND
	db -1 ; end
...
PsychicGroup:
	...
	db 17, GARDEVOIR,    HYPNOSIS, DISABLE, DREAM_EATER, NO_MOVE
	db -1 ; end
...
PicnickerGroup:
	...
	db 31, NINJASK,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end

	; PICNICKER (17)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 37, NINJASK,   ENCORE, DOUBLESLAP, MINIMIZE, METRONOME
	db -1 ; end
	...
	; PICNICKER (20)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 20, NINJASK,   ENCORE, SING, DOUBLESLAP, MINIMIZE
	db -1 ; end
	...
	; PICNICKER (26)
	db "TIFFANY@", TRAINERTYPE_MOVES
	db 43, NINJASK,   METRONOME, ENCORE, MOONLIGHT, MINIMIZE
	db -1 ; end
...
TwinsGroup:
	...
	db 16, NINJASK,   GROWL, ENCORE, DOUBLESLAP, METRONOME
...
BlueGroup:
	...
	db 56, LUDICOLO,    QUICK_ATTACK, WHIRLWIND, WING_ATTACK, MIRROR_MOVE
	...
	db 58, NUZLEAF,  SUNNY_DAY, LEECH_SEED, EGG_BOMB, SOLARBEAM
...
MysticalmanGroup:
	...
	db 23, GARDEVOIR,    DREAM_EATER, HYPNOSIS, DISABLE, CONFUSION
