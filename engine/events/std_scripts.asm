...
InitializeEventsScript:
	...
	setevent EVENT_NOT_GOT_POKEDEX
	...
	setevent EVENT_AZALEA_TOWN_RALTSS
	setevent EVENT_KURTS_HOUSE_RALTS
	...
	variablesprite SPRITE_AZALEA_ROCKET, SPRITE_GRUNT
	...
	setevent EVENT_MT_MOON_SQUARE_NINJASK
