...
GruntM28Script:
	...
	waitbutton
	closetext
	setevent EVENT_LEARNED_MIGHTYENA_TAIL
	end
...
.Script:
	...
	checkevent EVENT_LEARNED_MIGHTYENA_TAIL
	iffalse .NeedsPassword
	jump .OpenSesame
...
TeamRocketBaseB3F_MapEvents:
	...
	object_event  8,  3, SPRITE_GRUNT, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, ObjectEvent, EVENT_TEAM_ROCKET_BASE_B3F_EXECUTIVE
	...
	object_event 21,  7, SPRITE_GRUNT_GIRL, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, -1, PAL_NPC_RED, OBJECTTYPE_TRAINER, 0, SlowpokeTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
	object_event  5, 14, SPRITE_GRUNT, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, 0, OBJECTTYPE_TRAINER, 3, MightyenaTailGrunt, EVENT_TEAM_ROCKET_BASE_POPULATION
	...
	object_event 24, 14, SPRITE_GRUNT, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, 0, OBJECTTYPE_SCRIPT, 0, TeamRocketBaseB3FRocketScript, EVENT_TEAM_ROCKET_BASE_POPULATION
