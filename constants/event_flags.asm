...
; Johto story events
	...
	const EVENT_NOT_GOT_POKEDEX
	const EVENT_ROUTE104SOUTH_HIDDEN_POTION
	const EVENT_ROUTE104SOUTH_HIDDEN_ANTIDOTE
	const EVENT_ROUTE104SOUTH_POKEBALL
	const EVENT_PETALBURGWOODS_PARLYZHEAL
	const EVENT_GOT_SS_TICKET_FROM_ELM
	const EVENT_USED_THE_CARD_KEY_IN_THE_RADIO_TOWER
	const EVENT_PETALBURGWOODS_HIDDEN_POKEBALL
	const EVENT_PETALBURGWOODS_ETHER
	const EVENT_GOT_POTION
	const EVENT_PETALBURGWOODS_HIDDEN_TINYMUSHROOM1
	const EVENT_PETALBURGWOODS_HIDDEN_POTION
	const EVENT_PETALBURGWOODS_HIDDEN_TINYMUSHROOM2
	const EVENT_PETALBURGWOODS_GREATBALL
	const EVENT_PETALBURGWOODS_XATTACK
	const EVENT_GOT_TOGEPI_EGG_FROM_ELMS_AIDE
	const EVENT_MADE_UNOWN_APPEAR_IN_RUINS
	const EVENT_FAST_SHIP_DESTINATION_CIANWOOD
	...
	const EVENT_GOT_KINGS_ROCK_IN_RALTS_WELL
...
; More Johto story events
	...
	const EVENT_LEARNED_MIGHTYENA_TAIL
...
; Bug Catcher
	...
	const EVENT_BEAT_BUG_CATCHER_LYLE
...
; Crystal-exclusive trainer flags
	...
	const EVENT_BEAT_RICHBOY_WINSTON
; ???
	const EVENT_5CC
	const EVENT_5CD
	const EVENT_5CE
...
; Johto itemballs
	...
	const EVENT_ROUTE_102_POTION
	const EVENT_PETALBURG_MAX_REVIVE
	const EVENT_PETALBURG_ETHER
	const EVENT_PETALBURG_HIDDEN_RARE_CANDY
	...
	const EVENT_RALTS_WELL_B1F_SUPER_POTION
	const EVENT_RALTS_WELL_B2F_TM_RAIN_DANCE
...
; Johto people
	const EVENT_RIVAL_LITTLEROOT_TOWN
	const EVENT_RIVAL_ROUTE_103
	...
	const EVENT_ILEX_FOREST_SLAKOTH
	...
	const EVENT_CHARCOAL_KILN_SLAKOTH
	const EVENT_CHARCOAL_KILN_APPRENTICE
	const EVENT_CHARCOAL_KILN_BOSS
	const EVENT_ROUTE_36_SUDOWOODO
	const EVENT_AZALEA_TOWN_RALTSS
	const EVENT_AZALEA_TOWN_SLOWPOKETAIL_ROCKET
	const EVENT_RALTS_WELL_RALTSS
	const EVENT_RALTS_WELL_ROCKETS
	const EVENT_KURTS_HOUSE_RALTS
	...
	const EVENT_RALTS_WELL_KURT ; 740
...
; Kanto people
	...
	const EVENT_MT_MOON_SQUARE_NINJASK
...
; New to Crystal
	...
	const EVENT_CLOCK_SET
	const EVENT_DAD_ON_TV
