...
; Music indexes (see audio/music_pointers.asm)
	...
	const MUSIC_YOUNGSTER_ENCOUNTER          ; 36
	...
	const MUSIC_VERMILION_CITY               ; 3c
	const MUSIC_POKEMON_CHANNEL              ; 3d
	const MUSIC_POKE_FLUTE_CHANNEL           ; 3e
	const MUSIC_TIN_TOWER                    ; 3f
	const MUSIC_SPROUT_TOWER                 ; 40
	const MUSIC_BURNED_TOWER                 ; 41
	const MUSIC_LIGHTHOUSE                   ; 42
	const MUSIC_LAKE_OF_RAGE                 ; 43
	const MUSIC_INDIGO_PLATEAU               ; 44
	const MUSIC_ROUTE_37                     ; 45
	const MUSIC_ROCKET_HIDEOUT               ; 46
	const MUSIC_DRAGONS_DEN                  ; 47
	const MUSIC_RUINS_OF_ALPH_RADIO          ; 48
	const MUSIC_CAPTURE                      ; 49
	const MUSIC_ROUTE_26                     ; 4a
	const MUSIC_MOM                          ; 4b
	const MUSIC_VICTORY_ROAD                 ; 4c
	const MUSIC_POKEMON_LULLABY              ; 4d
	const MUSIC_POKEMON_MARCH                ; 4e
	const MUSIC_GS_OPENING                   ; 4f
	const MUSIC_GS_OPENING_2                 ; 50
	const MUSIC_MAIN_MENU                    ; 51
	const MUSIC_RUINS_OF_ALPH_INTERIOR       ; 52
	const MUSIC_ROCKET_OVERTURE              ; 53
	const MUSIC_DANCING_HALL                 ; 54
	const MUSIC_BUG_CATCHING_CONTEST_RANKING ; 55
	const MUSIC_BUG_CATCHING_CONTEST         ; 56
	const MUSIC_LAKE_OF_RAGE_ROCKET_RADIO    ; 57
	const MUSIC_PRINTER                      ; 58
	const MUSIC_POST_CREDITS                 ; 59
; new to Crystal
	const MUSIC_CLAIR                        ; 5a
	const MUSIC_MOBILE_ADAPTER_MENU          ; 5b
	const MUSIC_MOBILE_ADAPTER               ; 5c
